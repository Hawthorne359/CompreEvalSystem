...
urlpatterns = [
    ...
    path('report/project/<int:pk>/export/common-fields/', views.ReportExportFieldPreferenceAPIView.as_view(), name='report-export-common-fields'),
    ...
    path('report/student/submissions/<int:pk>/ranking/', views.ReportStudentRankingAPIView.as_view(), name='report-student-ranking'),
]
